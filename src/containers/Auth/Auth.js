...
class Auth extends Component {
    ...
    switchAuthModeHandler = () => { // Handler to change the Button from SignUp to SignIn
    ...
    inputChangedHandler = (event, controlName) => {
        const updatedControls = {
            ...this.state.controls,
            [controlName]: { // updating the copied state (not updating the state itself. This is done with below setState)
